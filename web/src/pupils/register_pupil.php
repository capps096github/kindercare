          ...
          <div class="max-w-xl mx-auto">
            <form class="space-y-6 ">
              ...
              <label class="block mt-4">
                ...
                <input type="text" name="usercode" placeholder="Your User Code e.g 234568KLP, 2442358KLP,288568KLP"
              ...
              <label class="block mt-4">
                ...
                <input type="number" name="phone_no"
                  placeholder="Your Phone Number e.g 0758294212, 0700444642, 0789601443" class="text-blue mt-1 w-full px-3 py-2 bg-white border border-white rounded-md text-sm shadow-sm
                  placeholder-blue/50 focus:outline-none focus:border-amber focus:ring-1 focus:ring-amber" required />
              </label>
