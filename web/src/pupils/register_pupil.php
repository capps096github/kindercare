  ...
  <section class="flex flex-col justify-between h-screen space-y-10">
    ...
    <nav class="flex justify-between items-center py-4  px-2">
      ...
      <span class="hover:cursor-pointer space-x-2 flex justify-center items-center mt-4 md:mt-0" title="NOIS">
        <div onclick="goToSplash('index')" class="flex text-white hover:text-amber hover:underline items-center space-x-2">
        ...
        <div class="max-w-xl mx-auto">
          <form class="space-y-6 ">
            ...
            <label class="block mt-4">
              ...
              <input type="text" name="usercode" placeholder="Your User Code e.g 234568KLP, 2442358KLP,288568KLP" class="text-blue mt-1 w-full px-3 py-2 bg-white border border-white rounded-md text-sm shadow-sm
