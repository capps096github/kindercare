  ...
  <body class="bg-lightblue font-spartan">
    <section class="flex flex-col justify-between h-screen space-y-10">
      ...
      <main class="md:mt-28 lg:mt-28 mt-40 p-4 space-y-4 w-full mx-auto">
        ...
        <div class="mb-10">
          <h2
            class="text-3xl text-blue tracking-tight mt-12 mb-10 text-center font-bold sm:text-4xl md:text-5xl mx-auto">
            All
                  ...
                  <table class="min-w-full divide-y divide-blue text-blue">
                    ...
                    <thead class="bg-blue">
                      <tr>
                        ...
                        <th scope="col" class="px-6 py-3  text-xs font-medium text-white uppercase text-center
                          tracking-wider">
                          Change Status
                        </th>
                    ...
                    <tbody class="bg-white divide-y divide-blue/40">
                      ...
                      <tr>
                        ...
                        <td class="px-6 py-4 text-green whitespace-nowrap text-sm ">
                          ...
                          <button
                            class="justify-center w-full py-2 px-4 border border-transparent text-sm  rounded-md text-red  bg-red/20 hover:bg-red hover:text-white transition-colors duration-300">
                            Deactivate
                          </button>
                      ...
                      <tr>
                        ...
                        <td class="px-6 py-4 text-green whitespace-nowrap text-sm ">
                          <!-- on click, call js code that calls the php file to change status -->
                          <button
                            class="justify-center w-full py-2 px-4 border border-transparent text-sm rounded-md text-green  bg-green/20 hover:bg-green hover:text-white transition-colors duration-300">
                            Activate
                          </button>
                        </td>
        ...
        <div class="mb-10">
          ...
          <div class="flex flex-col">
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
              <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                <div class="shadow overflow-hidden border-b border-darkred/40 sm:rounded-lg">
                  <table class="min-w-full divide-y divide-darkred text-darkred">
                    <!-- Heads -->
                    ...
                    <!-- Table Body -->
                    <tbody class="bg-white divide-y divide-darkred/20">
                      <!-- 1 -->
                      <tr>
                        <td class="px-6 py-4">
