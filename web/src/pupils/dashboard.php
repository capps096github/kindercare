                  ...
                  <tbody class="bg-white divide-y divide-blue/40">
                    ...
                    <tr>
                      ...
                      <td class="px-6 py-4 text-green whitespace-nowrap text-sm ">
                        ...
                        <button class="justify-center w-full py-2 px-4 border border-transparent text-sm  rounded-md text-red  bg-red/20 hover:bg-red hover:text-white transition-colors duration-300">
                          Deactivate
                        </button>
                    ...
                    <tr>
                      ...
                      <td class="px-6 py-4 text-green whitespace-nowrap text-sm ">
                        <!-- on click, call js code that calls the php file to change status -->
                        <button class="justify-center w-full py-2 px-4 border border-transparent text-sm rounded-md text-green  bg-green/20 hover:bg-green hover:text-white transition-colors duration-300">
                          Activate
                        </button>
                      </td>
