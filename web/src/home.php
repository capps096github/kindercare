...
<html lang="en">
  ...
  <body class="bg-lightblue font-spartan">
    <section class="flex flex-col justify-between h-screen">
      <!-- Nav Bar -->
      <nav
        class="md:flex md:justify-between lg:flex lg:justify-between md:px-4 px-2 py-2 sticky top-0 left-0 right-0 bg-blue">
        <!-- Logo -->
        <span class="hover:cursor-pointer space-x-2 flex justify-center items-center mt-4 md:mt-0" title="KINDERCARE">
          <div onclick="goToSplash()"
            class="flex font-bold text-white hover:text-amber hover:underline items-center space-x-2">
      ...
      <main class="mx-auto sm:max-w-6xl max-w-6xl px-4 sm:px-6  lg:px-8 ">
        ...
        <div class="mt-10 md:grid-cols-2 lg:grid-cols-2 grid-cols-1 gap-2 sm:max-w-6xl max-w-6xl mx-auto grid">
          ...
          <!-- Image -->
          <!-- <img src="../images/kids.jpg" alt="KinderCare Pupil" class="aspect-video"> -->
          ...
          <!-- Assignment -->
          <article onclick="goToAssignmentsDashboard()"
            class="hover:cursor-pointer bg-blue rounded-lg p-10 transition-colors duration-300 text-white hover:text-blue hover:bg-amber justify-center items-center">
