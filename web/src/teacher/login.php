        ...
        <div class="max-w-xl mx-auto">
          <form class="space-y-6 " action="../auth/login.php" method="post">
            ...
            <label class="block mt-4">
              ...
              <input type="password" name="login_password" id="password" placeholder="Your Password - Keep it Short, Secure and Secret" class="text-blue mt-1 w-full px-3 py-2 bg-white border border-white rounded-md text-sm shadow-sm
                  placeholder-blue/50 focus:outline-none focus:border-amber focus:ring-1 focus:ring-amber" required />
            </label>
            ...
            <!-- log in Button -->
            <!-- we used custom colors and they are red, white, blue, green, amber -->
            <!-- inorder to change the colour that wasnt among the colours we used, use style="background-color: aaaa;" -->
            <button type="submit" name="login_btn" class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-bold rounded-md text-blue uppercase bg-amber hover:bg-white transition-colors duration-300"> 
              <span class="absolute left-0 inset-y-0 flex items-center pl-3">

<!-- svg is for the icon on the button -->
            ...
            <p class="tracking-tight text-center text-sm text-amber sm:mt-2 sm:text-sm md:mt-2 p-4 lg:mx-0 ">
              Have no account?
              <a href="register.php" class="font-extrabold text-white hover:cursor-pointer ml-2 underline hover:text-amber hover:underline duration-300" title="Create your Account">
